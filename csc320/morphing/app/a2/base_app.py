...
class BaseAssignmentApp(Widget):
    ...
    def __init__(self, args):
        ...
        self.texture.blit_buffer(
            (self.buffer[..., :3] * 255).astype(np.uint8).tobytes(),
            colorfmt="rgb",
            bufferfmt="ubyte",
        )
        self.init_state()
        ...
        with self.canvas:
            Rectangle(
                ...
                pos=(0, 0),
                size=(self.app_resolution[1], self.app_resolution[0]),
            )
            Color(0.9, 0.9, 0.9)
        ...
        text_frame = Label(
            text=f"{self.num_frames}", color=(0, 0, 0), size_hint=(0.3, 0.25)
        )
        ...
        widget.add_widget(
            Label(text="num_frames", color=(0, 0, 0), size_hint=(0.3, 0.45))
        )
        ...
        widget.add_widget(
            Label(text="Left Image Buffer", color=(0, 0, 0), size_hint=(0.7, 0.7))
        )
        ...
        widget = BoxLayout(orientation="vertical")
        widget.add_widget(
            Label(text="Right Image Buffer", color=(0, 0, 0), size_hint=(0.7, 0.7))
        )
        row = BoxLayout(orientation="horizontal")
        ...
        widget = StackLayout()
        checkbox = CheckBox(
            active=self.edit_arrows, size_hint=(0.15, 0.45), color=(0, 0, 0)
        )
        ...
        widget.add_widget(
            Label(text="Edit Arrows", color=(0, 0, 0), size_hint=(0.7, 0.45))
        )
        menu.add_widget(widget)

        widget = StackLayout()
        checkbox = CheckBox(
            active=self.show_warped_cursor, size_hint=(0.15, 0.45), color=(0, 0, 0)
        )
        ...
        widget.add_widget(checkbox)
        widget.add_widget(
            Label(text="Show Warped Cursor", color=(0, 0, 0), size_hint=(0.7, 0.45))
        )
        menu.add_widget(widget)

        widget = StackLayout()
        checkbox = CheckBox(
            active=self.show_source_morph_lines, size_hint=(0.15, 0.45), color=(0, 0, 0)
        )
        ...
        widget.add_widget(checkbox)
        widget.add_widget(
            Label(text="Show Source Lines", color=(0, 0, 0), size_hint=(0.7, 0.45))
        )
        menu.add_widget(widget)

        widget = StackLayout()
        checkbox = CheckBox(
            active=self.show_destination_morph_lines,
            size_hint=(0.15, 0.45),
            color=(0, 0, 0),
        )
        ...
        widget.add_widget(checkbox)
        widget.add_widget(
            Label(text="Show Dest. Lines", color=(0, 0, 0), size_hint=(0.7, 0.45))
        )
        menu.add_widget(widget)

        widget = StackLayout()
        checkbox = CheckBox(
            active=self.run_realtime, size_hint=(0.15, 0.45), color=(0, 0, 0)
        )
        ...
        widget.add_widget(checkbox)
        widget.add_widget(
            Label(text="Run Realtime", color=(0, 0, 0), size_hint=(0.7, 0.45))
        )
        menu.add_widget(widget)

        widget = StackLayout()
        checkbox = CheckBox(
            active=self.verbose, size_hint=(0.15, 0.45), color=(0, 0, 0)
        )
        ...
        widget.add_widget(checkbox)
        widget.add_widget(
            Label(text="Verbose Mode", color=(0, 0, 0), size_hint=(0.7, 0.45))
        )
        menu.add_widget(widget)

        widget = StackLayout()
        checkbox = CheckBox(
            active=self.bilinear, size_hint=(0.15, 0.45), color=(0, 0, 0)
        )
        ...
        widget.add_widget(checkbox)
        widget.add_widget(
            Label(text="Bilinear", color=(0, 0, 0), size_hint=(0.7, 0.45))
        )
        menu.add_widget(widget)

        widget = StackLayout()
        checkbox = CheckBox(
            active=self.vectorize, size_hint=(0.15, 0.45), color=(0, 0, 0)
        )
        ...
        widget.add_widget(checkbox)
        widget.add_widget(
            Label(text="Vectorize", color=(0, 0, 0), size_hint=(0.7, 0.45))
        )
        menu.add_widget(widget)

        widget = StackLayout()
        checkbox = CheckBox(
            active=self.debug_grid, size_hint=(0.15, 0.45), color=(0, 0, 0)
        )
        ...
        widget.add_widget(checkbox)
        widget.add_widget(
            Label(text="Show Grid", color=(0, 0, 0), size_hint=(0.7, 0.45))
        )
        menu.add_widget(widget)
        ...
        text_patch = Label(
            text=f"{self.supersampling}", color=(0, 0, 0), size_hint=(0.3, 0.25)
        )
        ...
        widget.add_widget(slider)
        widget.add_widget(
            Label(text="supersampling", color=(0, 0, 0), size_hint=(0.3, 0.25))
        )
        ...
        text_a = Label(
            text=f"{self.param_a:.4f}", color=(0, 0, 0), size_hint=(0.3, 0.25)
        )
        ...
        text_b = Label(
            text=f"{self.param_b:.4f}", color=(0, 0, 0), size_hint=(0.3, 0.25)
        )
        ...
        text_p = Label(
            text=f"{self.param_p:.4f}", color=(0, 0, 0), size_hint=(0.3, 0.25)
        )
        ...
        text_t = Label(
            text=f"{self.param_t:.4f}", color=(0, 0, 0), size_hint=(0.3, 0.25)
        )
    ...
    def add_raster_line(self, origin, destination, color, line_width=1):
        vertex_buffer = np.zeros(
            2, [("position", np.float32, 2), ("color", np.float32, 4)]
        )
    ...
    def add_raster_lines(self, origins, destinations, colors, line_width=1):
        ...
        vertex_buffer["position"] = np.concatenate(
            [origins, destinations], axis=-1
        ).reshape(-1, 2)
        vertex_buffer["color"] = np.concatenate([colors, colors], axis=-1).reshape(
            -1, 4
        )
    ...
    def add_raster_point(self, origin, color, point_size=2):
        vertex_buffer = np.zeros(
            1, [("position", np.float32, 2), ("color", np.float32, 4)]
        )
    ...
    def add_raster_points(self, origins, colors, point_size=2):
        vertex_buffer = np.zeros(
            origins.shape[0], [("position", np.float32, 2), ("color", np.float32, 4)]
        )
    ...
    def draw_raster(self):
        for raster_line_buffer in self.raster_line_buffers:
            ...
            pixel_positions = img_ops.unnormalize_coordinates(
                vertex_buffer["position"], *self.app_resolution
            )
            obj = InstructionGroup()
            color = vertex_buffer["color"][0, :3]
            obj.add(Color(*list(color)))
            obj.add(
                Line(points=list(pixel_positions.reshape(-1)), width=line_width / 2)
            )
        ...
        for raster_point_buffer in self.raster_point_buffers:
            ...
            obj.add(
                Point(
                    points=list(pixel_positions.reshape(-1)), pointsize=point_size * 2
                )
            )
            self.objects.append(obj)
            self.canvas.add(obj)
