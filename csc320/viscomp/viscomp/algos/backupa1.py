...
def backward_mapping(
    ...
    # get the inverse of the homogeneous transformation matrix to use for backward mapping
    # h_inverse = np.linalg.inv(transform)
    # normalize matrix (make sure value at 2,2 is 1)
